...
int main()
{
	...
	// ikj работает быстрее так как загружает всю строку в кэш для обработки и не требует загружать из оп по новой
	// jki каждый раз загружает следующий элемент массива из памяти в кэш так как используется каждый раз разная строка массива
